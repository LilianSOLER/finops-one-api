...
export class AzureService {
   ...
   */
  // TODO Possible enhancement : using one transaction to combine all upsert operations and improve performance
   ...
   */
  // TODO Change the promise type to a more accurate type
  async getAzureMetricsGroupedByResourceGroupAndDate(): Promise<any> {
   ...
   */
  // TODO Change the promise type to a more accurate type
  async getAzureMetricsGroupedByResourceTypeAndDate(): Promise<any> {
    const metrics = await this.prisma.resourcesCostsValues.findMany({
      select: {
        cost: true,
        usageDate: true,
